...
public class CustomerGetTelephoneTest {
	...
	public void testValidTelephoneNumber() {
		...
		customer.setTelephone(validTelephone);
		// Act
		String returnedTelephone = customer.getTelephone();
		// Assert
		assertEquals("Telephone number does not match", validTelephone, returnedTelephone);
	}
	...
	public void testNullTelephoneNumber() {
		...
		String returnedTelephone = customer.getTelephone();
		// Assert
		assertNull("Telephone number is not null", returnedTelephone);
	}
	...
	public void testTelephoneModification() {
		...
		String returnedTelephone = customer.getTelephone();
		// Assert
		assertEquals("Telephone number does not match", newTelephone, returnedTelephone);
	}
